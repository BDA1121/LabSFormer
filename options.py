...
class Options():
    ...
    def init(self, parser):
        ...
        parser.add_argument('--train_dir', type=str, default='/home/ubuntu/src/istd-dataset/sabarinathan/istd-dataset/versions/1/ISTD_Dataset/train', help='dir of train data')
        parser.add_argument('--val_dir', type=str, default='/home/ubuntu/src/istd-dataset/sabarinathan/istd-dataset/versions/1/ISTD_Dataset/test', help='dir of train data')
